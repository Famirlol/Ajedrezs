/*
    Este archivo contiene funciones mienbro de el tablero.h
*/
...
// Funcion miembro que pone el tablero,puede elegir los colores en los parametros
...
// Dibujo de clases en sfml en windows
